...
<?php
      ...
      $strQuery = "SELECT distinct(t.Class) as class , count(distinct(t.Class)) as count FROM train_pnr_demo2 t  where t.TrainId = '".$_POST['no']."' and t.TravelDate like '".$_POST['date']."' group by t.Class";
